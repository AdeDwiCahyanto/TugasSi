    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Ubah Data Nilai</h1>
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('nilai.update', $nilai) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_nilai" value="{{ old('nama_nilai', $nilai->nama_nilai) }}" />
                        </div>
                        <div class="mb-3">
                            <label>bobot<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="bobot_nilai" value="{{ old('bobot_nilai', $nilai->bobot_nilai) }}" />
                        </div>
                        <div class="mb-3">
                            <button class="btn btn-primary">Save</button>
                            <a class="btn btn-danger" href="{{ route('nilai.index') }}">Back</a>
                        </div>
                    </form>
                </div>
            </div>
