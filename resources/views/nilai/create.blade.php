    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Tambah Data Nilai</h1>
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('nilai.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_nilai" value="{{ old('nama_nilai') }}" />
                        </div>
                        <div class="mb-3">
                            <label>bobot <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="bobot_nilai" value="{{ old('bobot_nilai') }}" />
                        </div>
                        <div class="mb-3">
