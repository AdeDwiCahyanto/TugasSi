    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Ubah Data Penilaian</h1>
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('penilaian.update', $penilaian) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label>Nilai penilaian<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="nilai_penilaian" value="{{ old('nilai_penilaian', $penilaian->nilai_penilaian) }}" />
                        </div>
                        <div class="mb-3">
                            <button class="btn btn-primary">Save</button>
                            <a class="btn btn-danger" href="{{ route('penilaian.index') }}">Back</a>
                        </div>
                    </form>
                </div>
            </div>
