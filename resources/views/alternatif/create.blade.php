                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('alternatif.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nilai_alternatif" value="{{ old('nilai_alternatif') }}" />
                        </div>
                        <div class="mb-3">
                            <label>nama truk <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="nama_truk" value="{{ old('nama_truk') }}" />
                        </div>
                        <div class="mb-3">
