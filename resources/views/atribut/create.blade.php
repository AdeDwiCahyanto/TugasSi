    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Tambah Data Atribut</h1>
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('atribut.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_atribut" value="{{ old('nama_atribut') }}" />
                        </div>
                        <div class="mb-3">
                            <label>nilai_atribut <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="nilai_atribut" value="{{ old('nilai_atribut') }}" />
                        </div>
                        <div class="mb-3">
