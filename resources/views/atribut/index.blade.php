            ...
            <div class="container-fluid px-4">
                ...
                <div class="card-body p-12 table-responsive">
                    ...
                    <table class="table table-bordered table-striped table-hover mb-12">
                        ...
                        <?php $no = 1 ?>
                        @foreach($atribut as $customer)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $customer->nama_atribut}}</td>
                            <td>{{ $customer->nilai_atribut}}</td>
                            <td>
                                <a class="btn btn-sm btn-warning" href="{{ route('atribut.edit', $customer) }}">Edit</a>
                                <form method="POST" action="{{ route('atribut.destroy', $customer) }}" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
