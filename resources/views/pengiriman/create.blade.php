                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('pengiriman.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="jumlah_pengiriman" value="{{ old('jumlah_pengiriman') }}" />
                        </div>
                        <div class="mb-3">
                            <label>Tanggal Pengiriman <span class="text-danger">*</span></label>
                            <input class="form-control" type="date" name="tanggal_pengiriman" value="{{ old('tanggal_pengiriman') }}" />
                        </div>
                        <div class="mb-3">
                            <label>Lokasi Awal</label>
                            <input class="form-control" type="text" name="lokasi_awal" value="{{ old('lokasi_awal') }}" />
                        </div>
                        <div class="mb-3">
                            <label>Lokasi Tujuan</label>
                            <input class="form-control" type="text" name="lokasi_tujuan" value="{{ old('lokasi_tujuan') }}" />
                        </div>
                        <div class="mb-3">
