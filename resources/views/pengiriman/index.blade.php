        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card-body p-12 table-responsive">
                    <div class="col">
                        <a class="btn btn-primary" href="{{ route('pengiriman.create') }}">Add</a>
                    </div>
                    <table class="table table-bordered table-striped table-hover mb-12">
                        ...
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $customer->barang->nama_barang}}</td>
                            <td>{{ $customer->kategori->nama_kategori}}</td>
                            <td>{{ $customer->jumlah_pengiriman }}</td>
                            <td>{{ $customer->tanggal_pengiriman }}</td>
                            <td>{{ $customer->lokasi_awal }}</td>
                            <td>{{ $customer->lokasi_tujuan }}</td>
                            <td>
                                <a class="btn btn-sm btn-warning" href="{{ route('pengiriman.edit', $customer) }}">Edit</a>
                                <form method="POST" action="{{ route('pengiriman.destroy', $customer) }}" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
