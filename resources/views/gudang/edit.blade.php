    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Ubah Data Gudang</h1>
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('gudang.update', $gudang) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_gudang" value="{{ old('nama_gudang', $gudang->nama_gudang) }}" />
                        </div>
                        <div class="mb-3">
                            <button class="btn btn-primary">Save</button>
                            <a class="btn btn-danger" href="{{ route('gudang.index') }}">Back</a>
                        </div>
                    </form>
                </div>
            </div>
