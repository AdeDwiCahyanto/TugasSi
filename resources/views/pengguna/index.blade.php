                ...
                <div class="card-body p-12 table-responsive">
                    <table class="table table-bordered table-striped table-hover mb-12">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-warning" href="{{ route('pengguna.edit', $customer) }}">Edit</a>
                                <form method="POST" action="{{ route('pengguna.destroy', $customer) }}" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
