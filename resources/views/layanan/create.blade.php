    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Tambah Data Layanan</h1>
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('layanan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_layanan" value="{{ old('nama_layanan') }}" />
                        </div>
                        <div class="mb-3">
                            <label>harga_layanan<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="harga_layanan" value="{{ old('harga_layanan') }}" />
                        </div>
                        <div class="mb-3">
                            <label>estimasi <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="estimasi" value="{{ old('estimasi') }}" />
                        </div>
                        <div class="mb-3">
                            <label>ongkir<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="ongkir" value="{{ old('onngkir') }}" />
                        </div>
                        <div class="mb-3">
