    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Ubah Data Outlet</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Ubah Data Outlet</li>
                </ol>
                @if($errors->any())
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('outlet.update', $outlet) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_outlet" value="{{ old('nama_outlet', $outlet->nama_outlet) }}" />
                        </div>
                        <div class="mb-3">
                            <button class="btn btn-primary">Save</button>
                            <a class="btn btn-danger" href="{{ route('outlet.index') }}">Back</a>
                        </div>
                    </form>
                </div>
            </div>
