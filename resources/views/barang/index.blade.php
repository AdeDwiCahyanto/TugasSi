        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card-body p-12 table-responsive">
                    <div class="col">
                        <a class="btn btn-primary" href="{{ route('barang.create') }}">Add</a>
                    </div>
                    <table class="table table-bordered table-striped table-hover mb-12">
                        ...
                        <tr>
                            ...
                            <td>{{ $customer->id_kategori}}</td>
                            <td>{{ $customer->harga }}</td>
                            <td>{{ $customer->jumlah }}</td>
                            <td>
                                <a class="btn btn-sm btn-warning" href="{{ route('barang.edit', $customer) }}">Edit</a>
                                <form method="POST" action="{{ route('barang.destroy', $customer) }}" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
