                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('barang.update', $barang) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}" />
                        </div>
                        <div class="mb-3">
                            <label>Harga Barang <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="harga" value="{{ old('harga', $barang->harga) }}" />
                        </div>
                        <div class="mb-3">
                            <label>Jumlah Barang</label>
                            <input class="form-control" type="text" name="jumlah" value="{{ old('jumlah', $barang->jumlah) }}" />
                        </div>
                        <div class="mb-3">
