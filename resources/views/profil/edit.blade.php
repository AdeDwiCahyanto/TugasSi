    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Ubah Data Profil</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Ubah Data Profil</li>
                </ol>
                @if($errors->any())
                ...
                <div class="card-body p-12 table-responsive">
                    <form action="{{ route('profil.update', $profil) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="nama_perusahaan" value="{{ old('nama_perusahaan', $profil->nama_perusahaan) }}" />
                        </div>
                        <div class="mb-3">
                            <label>Alamat Perusahaan<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="alamat" value="{{ old('alamat', $profil->alamat) }}" />
                        </div>
                        <div class="mb-3">
                            <label>Visi Perusahaan<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="visi" value="{{ old('visi', $profil->visi) }}" />
                        </div>
                        <div class="mb-3">
                            <label>Misi Perusahaan<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="misi" value="{{ old('misi', $profil->misi) }}" />
                        </div>
                        <div class="mb-3">
