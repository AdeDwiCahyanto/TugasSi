        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card-body p-12 table-responsive">
                    <div class="col">
                        <a class="btn btn-primary" href="{{ route('profil.create') }}">Add</a>
                    </div>
                    <table class="table table-bordered table-striped table-hover mb-12">
                        ...
                        <tr>
                            ...
                            <td>{{ $customer->misi}}</td>
                            <td>
                                <a class="btn btn-sm btn-warning" href="{{ route('profil.edit', $customer) }}">Edit</a>
                                <form method="POST" action="{{ route('profil.destroy', $customer) }}" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
